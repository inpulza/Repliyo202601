            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ¿Necesitas una cuenta? Escríbenos o visita{' '}
                  <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-lg bg-green-600 px-5 py-2 text-xs font-semibold text-white hover:bg-green-700 transition-colors shadow-sm"
