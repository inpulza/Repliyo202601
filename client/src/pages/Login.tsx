    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-gray-50 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Social Login Buttons - Disabled (single row) */}
          <div className="flex gap-2 mb-2">
            <Button
              type="button"
              variant="outline"
              className="flex-1 h-10 border-gray-200 font-medium opacity-40 cursor-not-allowed px-0"
              disabled
          ...
          <div className="mt-8 rounded-lg border border-gray-200 bg-white p-5" data-testid="invite-only-block">
            <div className="flex items-start gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-green-50 mt-0.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 inline-flex items-center gap-1.5 rounded-lg bg-green-600 px-4 py-2 text-xs font-semibold text-white hover:bg-green-700 transition-colors shadow-sm mt-0.5"
