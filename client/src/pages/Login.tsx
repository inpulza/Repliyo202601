    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-gray-50 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="mt-8 mb-3 text-center text-sm font-medium text-gray-900" data-testid="invite-only-label">
            Acceso por invitación
          </p>
          <div className="rounded-lg border border-gray-200 bg-white p-4" data-testid="invite-only-block">
