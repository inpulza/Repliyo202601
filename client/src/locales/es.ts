export const es = {
  ...
  testimonials: {
    items: [
      ...
      {
        quote: 'Mis pacientes me escriben por redes sociales y antes tardaba horas en responder. Con Repliyo respondo en minutos y no pierdo ningún mensaje.',
        name: 'Dra. Melva Reve',
        role: 'Psiquiatra, Healing Minds Psychiatry',
        highlight: 'respondo en minutos',
      },
      {
        quote: 'Nuestros clientes nos escriben por Instagram y Facebook preguntando por casas. Repliyo nos ayuda a responder al instante y no perder ningún lead.',
        name: 'Rosario & Xavier Abreu',
        role: 'Fundadores, XL Homes of SWFL',
        highlight: 'responder al instante',
      },
    ],
