...
export function ConversationCard({ conversation, isSelected, onClick }: ConversationCardProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        "w-full max-w-full text-left bg-transparent rounded-lg hover:bg-white/50 transition-all duration-200 relative overflow-hidden group pl-3 py-3 pr-3 border-b border-gray-300",
