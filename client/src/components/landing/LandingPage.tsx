...
import testimonialMelva from '../../assets/testimonial-melva.jpg';
import avatarAna from '@assets/generated_images/ana_customer_avatar_headshot.png';
import testimonialXLHomes from '../../assets/testimonial-xlhomes.jpg';
...
function HowItWorksMobile() {
  ...
  return (
    <section id="how" className="py-12 md:py-16 px-4 relative overflow-hidden mt-8 md:mt-12">
      ...
      <div className="relative overflow-hidden mx-auto max-w-sm min-h-[380px] bg-white">
