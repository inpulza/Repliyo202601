...
export function Sidebar() {
  ...
  return (
    <div className="h-screen w-[260px] bg-[#F5F5F7] text-gray-600 flex flex-col border-r border-gray-200 shrink-0 transition-all duration-300">
      ...
      <div className="p-5 flex items-center gap-3">
        ...
        <span className="font-bold text-base text-gray-900 tracking-tight">NexusFlow</span>
      </div>
